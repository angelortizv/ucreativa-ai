...
button_add = Button(
    root, text="+", padx=39, pady=20, command=lambda: Button_Add(e.get())
)
button_equal = Button(
    root, text="=", padx=91, pady=20, command=lambda: Button_Equal(e.get())
)

button_subtract = Button(
    root, text="-", padx=41, pady=20, command=lambda: Button_Subtract(e.get())
)
button_multiply = Button(
    root, text="*", padx=41, pady=20, command=lambda: Button_Multiply(e.get())
)
button_divide = Button(
    root, text="/", padx=41, pady=20, command=lambda: Button_Divide(e.get())
)
